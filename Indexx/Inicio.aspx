<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Inicio.aspx.cs" Inherits="Indexx.Inicio" %>
				   ...
				   <div class="box_content_center">
					   <div class="menu_box_list">
						   <ul>
							   ...
							   <li class="active"><a href="#about" class="scroll">Acerca de nosotros</a></li> 
							   <li><a href="#services" class="scroll">Servicios</a></li> 
							   <li><a href="#features" class="scroll">Features</a></li>
							   <li><a href="#work" class="scroll">Productos</a></li>
							   <li><a href="#skills" class="scroll">Skills</a></li>
							   <li><a href="#team" class="scroll">Team</a></li>
							   <li><a href="#contact" class="scroll">Contáctanos</a></li>
                               <li><a href="login.aspx"><i class="fa fa-sign-out pull-right"></i>Iniciar Sesion</a></li>
							</ul>
						</div>
	    ...
	    <div class="wmuSlider example1">
			   <article style="position: absolute; width: 100%; opacity: 0;"> 
			   	   <div class="banner-wrap">
						...
						<ul class="banner_btn">
						   <li class="grey"><a href="#">Empezar</a></li>
						   <li class="yellow"><a href="#">Leer más</a></li>
		    			 </ul>
					</div>
				</article>
				<article style="position: absolute; width: 100%; opacity: 0;"> 
   	   ...
   	   <div class="main">
   	   	 <div class="content_top" id="about">
   	   	 	<div class="container">
   	   	 		...
   	   	 		<p>CentroFarma plus la farmacia más cercana y con los mejores precios.</p>
   	   	 		<div class="row">
	   	   	 		<div class="col-md-4 service_box">
		  				<i class="icon1"> </i>
		  				<h3><a href='#'>CENTROFARMA </a></h3>
